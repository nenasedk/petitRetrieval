...
INPUT_DIR = '/home/ipa/quanz/user_accounts/evertn/SimulatedObs/BrownDwarf_v1/jwst_spectra/' # end with forward slash!
...
ATMOSPHERE = ['log_delta','log_gamma','t_int','t_equ','log_p_trans','alpha','log_g','log_P0']
parameters = []
...
for item in LINE_SPECIES:
    LOG_PRIORS[item] = lambda x: a_b_range(x, -10., 0.)
    PRIORS[item] = lambda x: uniform_prior(x, -10., 0.)
