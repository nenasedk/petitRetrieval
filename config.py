...
OBJ_NAME = 'WISE0855' #R_pl =   1.17*nc.r_jup_mean
...
# MUST INCLUDE: 'log_delta','log_gamma','t_int','log_p_trans','alpha','log_g','log_P0'
ATMOSPHERE = ['log_delta','log_gamma','t_int','R_pl','log_p_trans','alpha','log_g','log_P0'] #,'Kzz','fsed','sigma_lnorm']
parameters = []
parameters.extend(ATMOSPHERE)
parameters.extend(CLOUD_SPECIES)
parameters.extend(LINE_SPECIES)
#parameters.extend(FIXED_PARAMS)
